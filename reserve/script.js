...
if (hasRun == false || hasRun == undefined || hasRun == null) {
    ...
    let product1 = new productObj("Calfskin Bag", 19.95, "images/maroon-bag.png");
    let product2 = new productObj("Mask Group", 8995, "images/Mask-Group.png");
    let product3 = new productObj("Nice bag", 20, "images/nicebag.png");
    let product4 = new productObj("Gray Short", 99, "images/hat.png");
    let product5 = new productObj("Hat", 3995, "images/Grayshort.png");
...
$(document).ready(function () {
    ...
    // Laptop - R 8995, productArray[1]    
    $(".laptopProduct").click(function () {
    ...
    // Grapes - R19.95, productArray[0]  
    $(".grapesProduct").click(function () {
        getSessionStorage();
    ...
    // Olive oil - R99, productArray[3] 
    $(".oliveOilProduct").click(function () {
        getSessionStorage();
    ...
    // Computer screen - R3995, productArray[4] 
    $(".screenProduct").click(function () {
        getSessionStorage();
